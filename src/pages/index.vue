...
<template>
  ...
  <main class="flex flex-col items-center justify-center h-screen max-w-3xl px-4 py-16 mx-auto">
    <h1 class="pb-20 text-6xl text-center text-gray-700 transition-colors dark:text-gray-100">
    ...
    <div class="flex justify-center pb-10 space-x-4">
      <a
        ...
        class="inline-flex items-center px-6 py-4 space-x-1 font-medium transition duration-300 bg-indigo-600 rounded-md shadow-xl text-indigo-50 hover:bg-indigo-700 hover:shadow-md"
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
  ...
  <svg
    ...
    viewBox="0 0 998 260"
    fill="currentColor"
    class="absolute inset-x-0 bottom-0 w-full text-indigo-300 -z-10"
  >
